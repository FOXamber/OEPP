...
def get_args(description='whl'):
    ...
    parser.add_argument('--class_dim',
                        ...
                        default=0,
                        help='')
    parser.add_argument('--horizon_dim',
                        type=int,
                        default=0,
                        help='')
    parser.add_argument('--feat',
                        type=str,
                        default='videoclip',  # 1536
                        help='')
    ...
    parser.add_argument('--root',
                        type=str,
                        default="/data0/wanghanlin/planning_diffusion/dataset/crosstask/",
                        help='root path of dataset crosstask')
    parser.add_argument('--json_path_train',
                        type=str,
                        default="/data1/wanghanlin/diffusion_planning/jsons_crosstask105/sliding_window_cross_task_data_False_3_new_task_id_73.json",
                        help='path of the generated json file for train')
    parser.add_argument('--json_path_val',
                        type=str,
                        default="/data1/wanghanlin/diffusion_planning/jsons_crosstask105/sliding_window_cross_task_data_True_3_new_task_id_73_with_event_class.json",
                        help='path of the generated json file for val')

    parser.add_argument('--epochs', default=120, type=int, metavar='N',
                        help='number of total epochs to run')
    parser.add_argument('--split', default=1, type=int, metavar='N',
                        help='number of total epochs to run')
    parser.add_argument('--para_mse', default=0.5, type=float, metavar='weight',
                        help='')
    parser.add_argument('--para_ce', default=0.5, type=float, metavar='weight',
                        help='')
    ...
    parser.add_argument('--dist-url', default='tcp://localhost:21713', type=str,
                        help='url used to set up distributed training')
