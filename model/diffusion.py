...
class GaussianDiffusion(nn.Module):
    def __init__(self, model, horizon, observation_dim, action_dim, horizon_dim, class_dim, n_timesteps=200,
        ...
        self.loss_fn = Losses[loss_type](None, self.action_dim, self.horizon_dim, self.class_dim)
    ...
    def p_losses(self, x_start, cond, t):
        ...
        x_noisy = condition_projection(x_noisy, cond, self.action_dim, self.class_dim, self.horizon_dim)

        x_recon = self.model(x_noisy, t, cond)
        x_recon = condition_projection(x_recon, cond, self.action_dim, self.class_dim, self.horizon_dim)
        return x_recon
